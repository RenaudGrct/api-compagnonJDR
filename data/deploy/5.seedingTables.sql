...
INSERT INTO ability_score (strength, dexterity, constitution, wisdom, charisma, intelligence)
VALUES
(15, 10, 14, 12, 13, 11),
(15, 14, 13, 11, 12, 10)
;

INSERT INTO background (name, additional_language, ability, ability_description)
VALUES
...
INSERT INTO race (name, speed, extra_language, night_vision)
VALUES
('Drakéide', '9 m', 0, false),
('Humain', '9 m', 1, false)
;

INSERT INTO score_modifier (name, number)
VALUES
('Force', 2),
('Charisme', 1),
('Force', 1),
...
INSERT INTO world_language (name)
VALUES
('Commun'),
('Draconique'),
('Elfique'),
...
INSERT INTO racial_ability (name, description)
VALUES
...
INSERT INTO saving_throw (score)
VALUES
('Force'),
('Constitution'),
('Sagesse'),
...
INSERT INTO proficiencies (name, class_id)
VALUES
('Paladin', 1),
('Guerrier', 2)
;

INSERT INTO feature (name, description, number_of_use, use_reset, class_id)
VALUES
...
INSERT INTO feature_choice (name, description, feature_id)
VALUES
...
INSERT INTO has_score_modifier (race_id, score_modifier_id)
VALUES
(1, 1),
(1, 2),
(2, 1),
...
INSERT INTO has_world_language (race_id, world_language_id)
VALUES
(1, 1),
(1, 2),
(2, 1)
...
INSERT INTO has_racial_ability (race_id, racial_ability_id)
VALUES
(1, 1),
(2, 2)
;

INSERT INTO has_saving_throw (saving_throw_id, proficiencies_id)
VALUES
(3, 1),
(4, 1),
(1, 2),
...
INSERT INTO has_skill (skill_id, proficiencies_id, background_id)
VALUES
(1, 1, 1),
(2, 1, 1),
(6, 1, 2),
